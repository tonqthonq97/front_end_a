...
export function simpleTransitionAnimation(
    ...
    const contentEl = enteringEl; //.querySelector(':scope .ion-page');
    ...
    if (leavingEl) {
        ...
        if (backDirection) {
            ...
            leavingContent.fromTo(TRANSLATEX, CENTER, OFF_LEFT, true).beforeStyles({ opacity: 1 });
